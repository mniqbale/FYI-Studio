...
const CHANNEL_RECIPE: ProductionRecipe = {
  ...
  steps: [
    ...
    { id: 'video', capability: 'video:compose', worker_label: 'video-worker', requires_approval: false, input_mapping: { script: 'script.script', title: 'script.title', hook: 'script.hook', target_duration_seconds: 'script.target_duration_seconds' } },
  ],
};
