...
const QUEUE_NAME = 'research-queue';            // ADAPT
const COMPLETION_QUEUE = 'completion-queue';
const WORKER_ID = 'mock-research-v1';           // ADAPT
const WORKER_VERSION = '1.0.0';
const CAPABILITY = 'research:mock';             // ADAPT
...
function buildMockOutput(envelope: TaskEnvelope): Record<string, unknown> {
  ...
  return {
    research_brief: `Mock research brief for topic: ${topic}`,
    sources: ['mock-source-1', 'mock-source-2'],
    key_findings: ['Key finding 1', 'Key finding 2'],
    summary: `Summary generated for: ${topic}`,
  };
}
